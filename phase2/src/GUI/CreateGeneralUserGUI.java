...
/*
 *Author: Katrin
 * Description: GUI class that allows you to create a general user.
 */
...
public class CreateGeneralUserGUI extends JFrame {
    ...
    public CreateGeneralUserGUI(){
        ...
        submitBtn = new JButton(new AbstractAction("Create Account") {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(successCreate){
                    successCreate = userManager.createUser(user, name, password, allUsers);
                    if(successCreate){
