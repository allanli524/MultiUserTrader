...
/*
 *Author: Katrin
 * Description: GUI class that allows admin to edit their username.
 */
...
public class EditUsernameAdminGUI extends JFrame {
     ...
     */
    public EditUsernameAdminGUI(Admin account){
        ...
        submitBtn = new JButton(new AbstractAction("Change Username") {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(!allUsers.usernameTaken(newUsername) && !(newUsername.equals(account.getUsername())) && !(newUsername.equals(""))) {
                    adminManager.updateUsername(account, newUsername);
