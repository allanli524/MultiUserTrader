...
/*
 *Author: Katrin
 * Description: GUI class that allows admin to edit their password.
 */
...
public class EditPasswordAdminGUI {
     ...
     */
    public EditPasswordAdminGUI(Admin account){
        ...
        submitBtn = new JButton(new AbstractAction("Change Password") {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(newPass.length() > 8 && newPass.matches("[a-zA-Z0-9]*") && !(newPass.equals(""))) {
                    adminManager.updatePassword(account, newPass);
